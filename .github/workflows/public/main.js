            ...
            <main class="main-content">
                <div class="top-bar">
                    <div style="display:flex; align-items:center; gap: 16px;">
                         <button onclick="window.setView('dashboard')" style="font-size: 14px; color: var(--text-muted)">←</button>
                    ...
                    <div style="max-width: 800px; margin: 0 auto;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 16px;">
                            <div class="card" style="padding: 16px; border-style: dashed; text-align: center; color: var(--text-muted);">
                                 <p>Stream features (announcements, messaging) are being simplified...</p>
                            </div>
                        </div>
                    </div>
                </div>
...
async function loadClasses() {
    ...
    try {
        ...
        list.innerHTML = classes.map(cls => `
            <div class="card" onclick="window.enterClass('${cls.class_id}')" style="cursor:pointer">
        ...
        list.innerHTML = '<p>Error loading classes.</p>';
    }
}
        ...
        modalBody.innerHTML = `
            ...
            <form id="join-class-form">
                <div class="form-group">
                    ...
                    <input type="text" id="class-code" required placeholder="ABCDEF" maxlength="6" style="text-transform: uppercase;">
                </div>
